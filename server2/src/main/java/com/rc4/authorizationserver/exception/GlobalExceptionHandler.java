...
import com.rc4.authorizationserver.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleRessourceNotFoundException(RessourceNotFoundException e, WebRequest webRequest) {
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(
                webRequest.getDescription(true),
                HttpStatus.NOT_FOUND,
                e.getMessage(),
